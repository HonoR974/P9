...
public interface ComptabiliteManager {
     ...
     * La référence d'une écriture comptable est composée du code du journal dans
     * lequel figure l'écriture
     * suivi de l'année et d'un numéro de séquence (propre à chaque journal) sur 5
     * chiffres incrémenté automatiquement
